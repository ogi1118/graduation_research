...
class SentenceConverter:
    def __init__(self, csv_file_name, column_name1, column_name2) -> None:
        ...
        self.sentence_list_pair, self.max_sentence_num = sentence_finder.get_sentence_pair_list(column_name1, column_name2)
        self.sentence_lists=  [sentence_finder.get_sentence_list(column_name1), sentence_finder.get_sentence_list(column_name2)]
    ...
    def convert(self, max_sentence_number):
        if max_sentence_number < self.max_sentence_num:
            ...
            return None, None
        se = SentenceEncoder()
        embedding_tensor, unpadding_flags = se.doc_encode(self.sentence_list_pair, max_sentence_number=max_sentence_number)
...
if __name__ == '__main__':
    sf = SentenceFinder("/home/masaomi/gpbl_log/sources/gpbl_log/dataset20240126.csv")
    ...
    sc = SentenceConverter("/home/masaomi/gpbl_log/sources/gpbl_log/dataset20240126.csv", "curiosity", "interesting_facts_or_information")
